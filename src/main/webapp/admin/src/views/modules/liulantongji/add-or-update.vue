<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="浏览量" prop="liulanliang">
          <el-input v-model="ruleForm.liulanliang" 
              placeholder="浏览量" clearable  :readonly="ro.liulanliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="浏览量" prop="liulanliang">
              <el-input v-model="ruleForm.liulanliang" 
                placeholder="浏览量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `liulantongji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.liulantongjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
