<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐赠物" prop="juanzengwu">
          <el-input v-model="ruleForm.juanzengwu" 
              placeholder="捐赠物" clearable  :readonly="ro.juanzengwu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐赠物" prop="juanzengwu">
              <el-input v-model="ruleForm.juanzengwu" 
                placeholder="捐赠物" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收获地址" prop="shouhuodizhi">
          <el-input v-model="ruleForm.shouhuodizhi" 
              placeholder="收获地址" clearable  :readonly="ro.shouhuodizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收获地址" prop="shouhuodizhi">
              <el-input v-model="ruleForm.shouhuodizhi" 
                placeholder="收获地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='juanzengwu'){
            this.ruleForm.juanzengwu = obj[o];
	    this.ro.juanzengwu = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zaixianjuanzeng/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zaixianjuanzengCrossAddOrUpdateFlag = false;
						 this.parent.search();
